 ...
 * opyright (c) 1999 - 2001, International Business Machines Corporation.
 * All Rights Reserved.
 *
...
public class DefaultControlPipe
{
	public static void main(String argv[]) throws UnsupportedEncodingException, UsbException
	{
		...
		for(Object l : allUsbDevices){
			System.out.println("---------------");
			System.out.println(l.toString());
			UsbDevice d = (UsbDevice) l;
			try {
				System.out.println("0x"+UsbUtil.toHexString(d.getUsbDeviceDescriptor().idProduct()));
				System.out.println(d.getUsbDeviceDescriptor());
